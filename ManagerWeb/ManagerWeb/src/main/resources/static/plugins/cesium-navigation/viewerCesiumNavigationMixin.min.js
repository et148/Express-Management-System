...
function() {
    ...
    function(a, b) {
        ...
        function p(a, b, c) { ["pop", "push", "reverse", "shift", "sort", "splice", "unshift"].forEach(function(d) {
                var e = a[d];
                a[d] = function() {
    ...
    function(defined, CesiumMath, getTimestamp, EventHelper, Transforms, SceneMode, Cartesian2, Cartesian3, Matrix4, BoundingSphere, HeadingPitchRange, Knockout, loadView, ResetViewNavigationControl, ZoomNavigationControl, svgCompassOuterRing, svgCompassGyro, svgCompassRotationMarker, Utils) {
        ...
        NavigationViewModel.prototype.show = function(container) {
            var testing = ''
            + '<div class="compass" data-bind="visible: showCompass, event: { mousedown: handleMouseDown, dblclick: handleDoubleClick }">' 
            ...
            + ' <div class="compass-gyro-background"></div>' + ' <div class="compass-gyro" data-bind="cesiumSvgPath: { path: svgCompassGyro, width: 145, height: 145 }, css: { \'compass-gyro-active\': isOrbiting }"></div>' 
            + "</div>" 
            + '<div class="navigation-controls" style="border:none">' 
            + '<div style="border:1px solid rgba(255,255,255,.1);border-radius: 20px !important;position: absolute;left:-9px;top:2px;width:40px;height:105px;background:rgba(47,53,60,.8)">' 
            + "</div>" 
            + '<div data-unit="5" class="fa fa-angle-up" style="position: absolute;font-size: 24px;width:24px;cursor:pointer;text-align:center;color:white;" data-bind="event: { click: handleOrbitClick }"></div>'
            + '<div data-unit="-5" class="fa fa-angle-down" style="position: absolute;top:25px;font-size: 24px;width:24px;cursor:pointer;text-align:center;color:white;" data-bind="event: { click: handleOrbitClick }"></div>'
            + '<div data-dir="u" class="up fa fa-angle-up" style="position: absolute;top:50px;font-size: 24px;width:24px;cursor:pointer;text-align:center;color:white;" data-bind="event: { click: handleDirectionClick }"></div>'
            + '<div data-dir="d" class="down fa fa-angle-down" style="position: absolute;top:80px;font-size: 24px;width:24px;cursor:pointer;text-align:center;color:white;" data-bind="event: { click: handleDirectionClick }"></div>'
            + '<div data-dir="l" class="left fa fa-angle-left" style="position: absolute;top:65px;left:-15px;font-size: 24px;width:24px;cursor:pointer;text-align:center;color:white;" data-bind="event: { click: handleDirectionClick }"></div>'
            + '<div data-dir="r" class="right fa fa-angle-right" style="position: absolute;top:65px;left:14px;font-size: 24px;width:24px;cursor:pointer;text-align:center;color:white;" data-bind="event: { click: handleDirectionClick }"></div>'	
            + "</div>" 
...
//            + "</div>"
        ...
        NavigationViewModel.prototype.handleMouseDown = function(viewModel, e) {;
            ...
            var clickLocation = new Cartesian2((compassRectangle.right - compassRectangle.left) / 2, e.clientY - compassRectangle.top);
        ...
        NavigationViewModel.prototype.handleDirectionClick=function(viewModel, e){
            var dir=$(e.target).attr("data-dir");
            var scene = this.terria.scene;
            var ellipsoid= scene.globe.ellipsoid;
            var cameraHeight = ellipsoid.cartesianToCartographic(this.terria.camera.position).height;
            switch(dir){
                case "u":
                	this.terria.camera.moveDown(cameraHeight / 10.0);
                    break;
                case "d":
                	this.terria.camera.moveUp(cameraHeight / 10.0);
                    break;
                case "l":
                    this.terria.camera.moveRight(cameraHeight / 10.0);
                    break;
                case "r":
                	this.terria.camera.moveLeft(cameraHeight / 10.0);
                    break;
            }
        }
        NavigationViewModel.prototype.handleOrbitClick = function(viewModel, e) {
            ...
            var maxDistance = compassRectangle.width / 2;
            var center = new Cartesian2((compassRectangle.right - compassRectangle.left) / 2, (compassRectangle.bottom - compassRectangle.top) / 2);
            var clickLocation = new Cartesian2((compassRectangle.right - compassRectangle.left) / 2, (compassRectangle.bottom - compassRectangle.top) / 2-unit);
            var vector = Cartesian2.subtract(clickLocation, center, vectorScratch);
            var distanceFromCenter = Cartesian2.magnitude(vector);
            var distanceFraction = distanceFromCenter / maxDistance;
            var nominalTotalRadius = 145;
            var norminalGyroRadius = 50;
            console.info(vector);
            orbitUnit(this, compassElement, vector)
        };
        var oldUnit;
        ...
        function orbit(viewModel, compassElement, cursorVector) {
            ...
            viewModel.orbitMouseMoveFunction = function(e) {
                ...
                var center = new Cartesian2((compassRectangle.right - compassRectangle.left) / 2, (compassRectangle.bottom - compassRectangle.top) / 2);
                var clickLocation = new Cartesian2((compassRectangle.right - compassRectangle.left) / 2.0, e.clientY - compassRectangle.top);
                var vector = Cartesian2.subtract(clickLocation, center, vectorScratch);
        ...
        function orbitUnit(viewModel, compassElement, cursorVector) {
            var scene = viewModel.terria.scene;
            var camera = scene.camera;
            var center = Utils.getCameraFocus(viewModel.terria, true, centerScratch);
            if (!defined(center)) {
