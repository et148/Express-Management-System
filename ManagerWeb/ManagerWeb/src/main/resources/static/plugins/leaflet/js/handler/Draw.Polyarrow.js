...
L.Draw.Polyarrow = L.Draw.Feature.extend({
	...
	_fireCreatedEvent: function () {
		...
		var leftPolyline = L.polyline(this._arrow.getLatLngs(), this.leftOptions).addTo(map.getMap());

		var rightPolyline = L.polyline(this._arrow.getLatLngs(), this.rightOptions).addTo(map.getMap());
